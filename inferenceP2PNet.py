...
def get_prediction(file):  
    ...
    """
    #Loading file directly
    checkpoint = torch.load(Path('/Users/pratyushgupta/Desktop/Crowd-Counting-Platform-main/SHTechA.pth'), map_location='cpu')
    model.load_state_dict(checkpoint['model'])
    ...
    if (file.endswith(".mp4")):
        ...
        cv2.imwrite('./demo2.jpg', img_to_draw)
...
predict_cnt, density_path = get_prediction('/Users/pratyushgupta/Desktop/ UGP archives/19.jpg')
print(f"Predicted count: {predict_cnt}, Density map saved at: {density_path}")
